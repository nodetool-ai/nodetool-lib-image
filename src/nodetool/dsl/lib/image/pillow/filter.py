...
class Blur(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to blur.')
...
class Canny(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to canny.')
...
class Contour(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to contour.')
...
class ConvertToGrayscale(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to convert.')
...
class Emboss(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to emboss.')
...
class Expand(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to expand.')
...
class FindEdges(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to find edges.')
...
class GetChannel(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to get the channel from.')
    channel: nodetool.nodes.lib.image.pillow.filter.GetChannel.ChannelEnum = Field(default=nodetool.nodes.lib.image.pillow.filter.GetChannel.ChannelEnum.RED, description=None)
...
class Invert(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to adjust the brightness for.')
...
class Posterize(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to posterize.')
...
class Smooth(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to smooth.')
...
class Solarize(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to solarize.')
