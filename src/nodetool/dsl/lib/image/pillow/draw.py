...
class Background(GraphNode):
    ...
    color: types.ColorRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ColorRef(type='color', value='#FFFFFF'), description=None)
...
class RenderText(GraphNode):
    ...
    font: nodetool.nodes.lib.image.pillow.draw.RenderText.TextFont = Field(default=nodetool.nodes.lib.image.pillow.draw.RenderText.TextFont.DejaVuSans, description='The font to use.')
    ...
    color: types.ColorRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ColorRef(type='color', value='#000000'), description='The font color.')
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to render on.')
