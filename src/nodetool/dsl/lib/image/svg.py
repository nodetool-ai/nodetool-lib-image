...
class CircleNode(GraphNode):
    ...
    fill: types.ColorRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ColorRef(type='color', value='#000000'), description='Fill color')
    stroke: types.ColorRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ColorRef(type='color', value='none'), description='Stroke color')
...
class ClipPath(GraphNode):
    ...
    clip_content: types.SVGElement | GraphNode | tuple[GraphNode, str] = Field(default=None, description='SVG element to use as clip path')
    content: types.SVGElement | GraphNode | tuple[GraphNode, str] = Field(default=None, description='SVG element to clip')
...
class DropShadow(GraphNode):
    ...
    color: types.ColorRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ColorRef(type='color', value='#000000'), description='Color for shadow')
...
class Gradient(GraphNode):
    ...
    gradient_type: nodetool.nodes.lib.image.svg.Gradient.GradientType = Field(default=nodetool.nodes.lib.image.svg.Gradient.GradientType.LINEAR, description='Type of gradient')
    ...
    color1: types.ColorRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ColorRef(type='color', value='#000000'), description='Start color of gradient')
    color2: types.ColorRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ColorRef(type='color', value='#FFFFFF'), description='End color of gradient')
...
class LineNode(GraphNode):
    ...
    stroke: types.ColorRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ColorRef(type='color', value='#000000'), description='Stroke color')
    stroke_width: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Stroke width')
...
class Text(GraphNode):
    ...
    SVGTextAnchor: typing.ClassVar[type] = nodetool.nodes.lib.image.svg.SVGTextAnchor
    ...
    fill: types.ColorRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ColorRef(type='color', value='#000000'), description='Text color')
    text_anchor: nodetool.nodes.lib.image.svg.SVGTextAnchor = Field(default=nodetool.nodes.lib.image.svg.SVGTextAnchor.START, description='Text anchor position')
...
class Transform(GraphNode):
    ...
    content: types.SVGElement | GraphNode | tuple[GraphNode, str] = Field(default=None, description='SVG element to transform')
